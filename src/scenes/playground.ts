...
export class PlayGround implements Scene {
    ...
    configureWorld(): World {
        ...
        function skyBoxDemo(): Shape[] {
            ...
            const s3 = new Sphere();
            s3.transform = multiply(
                translation(0, 0, 7),
                scaling(0.8, 0.8, 0.8)
            );
            s3.material = m;

            return [skybox, s1, s2, s3];
        }
        ...
        world.objects.push(
            ...groupsDemo(),
            reflectiveFloor(color(0.2, 0.2, 0.2))
        );
