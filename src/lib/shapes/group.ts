...
import { Bounds, boundsContainsBounds, intersectsBounds, splitBounds, transformGroupBounds } from './bounds';
...
export class Group extends Shape {
    ...
    protected localIntersects(r: Ray): Intersection[] {
        return intersectsBounds(this.bounds(), r) 
            ? this.shapes.flatMap(x => x.intersects(r)).sort((a, b) => a.time - b.time)
            : [];
    }
